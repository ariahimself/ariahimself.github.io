...
<!-- 
I am doing a **concurrent** Ph.D. in **Electrical Engineering** and **Mathematics** (*Separate degrees*) at Northeastern University supervised by **Jennifer Dy** (EE) and **Milen Yakimov** (M). In the summer 2024, I will defend my Ph.D. in Electrical Engineering specialized in **Explanaible Machine Learning** methods and I plan to defend my Math Ph.D. specialized in **Noncommutative algebra and Noncommutative Algebraic Geoemetry** in the Fall 2024. 

I spent Spring 2024 as the Associate Program member at the Simons Laufer Mathematical Sciences Institute (formerly MSRI), where I was a member of [Noncommutative Algebraic Geometry](https://www.slmath.org/programs/356#members).



In Machine Learning my interestes lie in the span of:
...
- Deep Learning Theory: We try to come up with new ways to do Learning in Neural Networks without the usage of backpropagation which leads to more intutive and faster approaches. 
...
-The Interface between Machine Learning and Biology: We use variety of such approaches we develope above on more applied datas such as:
...
In Mathematics my interestes lie in:
...
I have Undertaked up to *20 advanced pure mathematical courses*  such as Riemannian Geometry, Algebraic Geometry, Functional Analysis, and etc alongside my main curriculum, providing a robust mathematical and formal foundation for addressing research challenges in Mathematics and Machine Learning.


I have Contributed to top conferences with Technical Machine Learning papers, including **5 papers in NeurIPS** (Ranked #2 in AI) including a *spotlight*, 1 *spotlight* paper in **ICLR** (Ranked #1 in AI), **3 paper in AISTAT**, and a paper in the **Neural Network Journal** and etc. Furthermore we published papers in applied biology journals such as **American Journal of Respiratory and Critical Care Medicine** and **PLOS computational Biology**, **Chest** and **Journal of biometrics & biostatistics**.
